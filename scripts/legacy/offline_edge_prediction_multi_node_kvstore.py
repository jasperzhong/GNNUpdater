...
import gnnupdater.distributed
import gnnupdater.distributed.graph_services as graph_services
from gnnupdater import DynamicGraph
from gnnupdater.config import get_default_config
from gnnupdater.distributed.dist_graph import DistributedDynamicGraph
...
from gnnupdater.utils import (EarlyStopMonitor, build_dynamic_graph, get_batch,
...
def main():
    ...
    if args.partition:
        ...
        mem = psutil.virtual_memory().percent
        logging.info("memory usage: {}".format(mem))
        gnnupdater.distributed.initialize(args.rank, args.world_size,
                                       args.partition_strategy,
                                       args.num_nodes, args.data,
                                       args.dim_memory)
        gnnupdater.distributed.dispatch_full_dataset(args.rank, args.data,
