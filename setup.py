...
gnnupdater_lib = Extension(
    "libgnnupdater", sources=[]
)
...
setup(
    name="gnnupdater",
    version="0.0.1",
    description="GNNUpdater: Adaptive Self-Triggered Training Framework for Continual Graph Learning",
    license="Apache 2.0",
    url="https://github.com/jasperzhong/GNNUpdater",
    packages=find_packages(exclude=("tests")),
    ext_modules=[gnnupdater_lib],
